           ...
           <div class="clearfix"></div>
             <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Editar Estudiants </h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">

                    <form class="form-horizontal form-label-left" method="POST" action="<?php echo URL."student/edit/".$datos["id"]; ?>" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <?php if($datos['wantsToReceiveOffers']):?>
                                <input name="offers" style="margin-top: 10px;" type="checkbox" checked>
                            <?php else:?>
                                <input name="offers" style="margin-top: 10px;" type="checkbox">
                            <?php endif;?>
                        </div>
                      </div>
