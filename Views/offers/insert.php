           ...
           <div class="clearfix"></div>
             <div class="row">
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                 <form class="form-horizontal form-label-left" method="POST" action="<?php echo URL."offer/insert/".$id_company; ?>" >
                       <?php if($id_company == ""):?>  
                        <!--SI VE DEL LLISTAT D'OFERTES LI DEIXO TRIAR EMPRESA A LA QUE PERTANY L'OFERTA-->
                                ...
                                <div class="control-group">
                                  <div class="controls">
                                    <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                      <input type="text" name="fi" class="form-control has-feedback-left" id="single_cal1" placeholder="dd/mm/aaaa" aria-describedby="inputSuccess2Status" required>
