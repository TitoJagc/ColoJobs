<?php namespace Models;
	...
	class Users{
		...
		public function showMunicipalities(){
		...
		public function edit(){
			$sql = "UPDATE User SET name = '{$this->name}', pwd = '{$this->pwd}', dateOfBirth = '{$this->dateOfBirth}', telephone = '{$this->telephone}', addressStreet = '{$this->addressStreet}', municipality = '{$this->municipality}', postalCode
			 = '{$this->postalCode}', email = '{$this->email}', role = '{$this->role}', image = '{$this->image}' WHERE id = '{$this->id}'";
			$this->con->consultaSimple($sql);
		}
